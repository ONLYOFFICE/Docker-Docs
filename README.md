...
You can create your own process for building and pushing Docker-Docs images using our github ci actions. To do this:
...
Follow to Settings >> Secrets and Variables >> Actions >> Variables >> Repository Variables
...
If the variable value is `onlyoffice`, the images will be push to `docker.io/onlyoffice/docs-docservice:<some_version>`
