    ...
    for ep_ip in ep_ds:
        try:
            ...
            try:
                ...
                logger_endpoints_ds.error(f'Error when reading data to the Pod... {msg_read_pod}')
                ver_ds = 'none'
                pod_tag = 'none'
            else:
                try:
                ...
                try:
                    ...
                    logger_endpoints_ds.error(f'Error when reading the tag to the Pod... {msg_read_pod}')
                    pod_tag = 'none'
